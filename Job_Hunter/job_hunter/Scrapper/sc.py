...
def scrape_jobs_linkdin(position,location,skills):
    ...
    URL = f"http://api.scraperapi.com?api_key=08ce1d9dbacc70a7e3eb189a637b1a7c&url=https://www.linkedin.com/jobs/search/?keywords={position}&location={location}"
    ...
    if job_elems:
        for job_elem in job_elems:
            ...
            # print(data)
            page = requests.get("http://api.scraperapi.com?api_key=08ce1d9dbacc70a7e3eb189a637b1a7c&url="+link_elem)
